...
net = cv2.dnn.readNet("./DAY_05/yolov3.weights", "./DAY_05/yolov3.cfg")
classes = []  # classes are categories that we are detecting
with open("./DAY_05/coco.names", "r") as f:  # loading classes
...
# Loading image
img_org = cv2.imread('./DAY_05/data/BCN_corners.jpg')
...
corners_geo = pd.read_csv('./DAY_05/data/BCN_corners_3857.csv')
print(corners_geo)
